...
class ApiResponse(Model):
    ...
    def __init__(self, code: int=None, id: int=None, message: str=None):  # noqa: E501
        """ApiResponse - a model defined in Swagger

        :param code: The code of this ApiResponse.  # noqa: E501
        :type code: int
        :param id: The id of this ApiResponse.  # noqa: E501
        :type id: int
    ...
    @property
    def id(self) -> int:
        """Gets the id of this ApiResponse.


        :return: The id of this ApiResponse.
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id: int):
        """Sets the id of this ApiResponse.


        :param id: The id of this ApiResponse.
        :type id: int
        """
